...
void encrypt_3des(unsigned char* key,unsigned char* input,int inputLength,
			 unsigned char** output,int *outputLength)
{
	...
	des3_set_2keys( &ctx3, &key[0], &key[8]);
	...
	for(i=0;i<inputLength/8;i++)
	{
		...
		memcpy(&temp[i*8],out,8);
	}
	*outputLength=inputLength;
}

void decrypt_3des(unsigned char* key,unsigned char* input,int inputLength,
			 unsigned char** output,int *outputLength)
{
	des3_context ctx3;
...
void encrypt_des(unsigned char* key,unsigned char* input,int inputLength,
			 unsigned char** output,int *outputLength)
{
	unsigned char in[8],out[8];
	des_context ctx;
...
void decrypt_des(unsigned char* key,unsigned char* input,int inputLength,
			 unsigned char** output,int *outputLength)
{
	des_context ctx;
	unsigned char in[8],out[8], in2[8];
